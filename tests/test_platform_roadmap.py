...
# compute_state_dict") is observed via facade attribute access: the mechanism every external
# patch site of this attribute (the package conftest, test_main_branches, and the two
# root-level harnesses) depends on.
# ---------------------------------------------------------------------------
