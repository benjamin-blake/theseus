"""Mirror test for scripts/checks/prose/_manifest.py (Decision 169, amends Decision 104)."""
...
from scripts.checks.prose import _manifest


class TestProseManifest:
    """Every prose Entry names a bare-literal module/attr pair resolving to the same-named
    ...
    def test_entry_module_is_inside_this_domain_package(self, entry) -> None:
        assert entry.module.startswith("scripts.checks.prose.")
