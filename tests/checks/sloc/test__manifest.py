"""Mirror test for scripts/checks/sloc/_manifest.py (Decision 169, amends Decision 104)."""
...
from scripts.checks.sloc import _manifest


class TestSlocManifest:
    """Every sloc Entry names a bare-literal module/attr pair resolving to the same-named
    ...
    def test_entry_module_is_inside_this_domain_package(self, entry) -> None:
        assert entry.module.startswith("scripts.checks.sloc.")
