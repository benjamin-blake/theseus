"""Mirror test for scripts/checks/prompts/_manifest.py (Decision 169, amends Decision 104)."""
...
from scripts.checks.prompts import _manifest


class TestPromptsManifest:
    """Every prompts Entry names a bare-literal module/attr pair resolving to the same-named
    ...
    def test_entry_module_is_inside_this_domain_package(self, entry) -> None:
        assert entry.module.startswith("scripts.checks.prompts.")
