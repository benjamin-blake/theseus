...
ENTRIES: tuple[Entry, ...] = (
    ...
    Entry(
        name="validate_schedule_removal_markers",
        module="scripts.checks.ci_guards.validate_schedule_removal_markers",
        attr="validate_schedule_removal_markers",
        pre=True,
        pre_globs=(
            ".github/workflows/**",
            "scripts/checks/ci_guards/validate_schedule_removal_markers.py",
            "scripts/checks/_common.py",
            "scripts/checks/_marker_guard.py",
            "scripts/checks/registry.py",
            "scripts/decisions_md.py",
