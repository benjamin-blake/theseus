...
ENTRIES: tuple[Entry, ...] = (
    ...
    Entry(
        name="check_roadmap_regrowth",
        module="scripts.checks.roadmap.check_roadmap_regrowth",
        attr="check_roadmap_regrowth",
        pre=True,
        pre_globs=(
            "docs/ROADMAP-*",
            "scripts/checks/roadmap/**",
    ...
    Entry(
        name="validate_roadmap_liveness",
        module="scripts.checks.roadmap.validate_roadmap_liveness",
        attr="validate_roadmap_liveness",
        pre=True,
        pre_globs=(
            "docs/ROADMAP-*",
            "docs/DECISIONS.md",
